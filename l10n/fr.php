...
"There is already a pending registration with this email, a new verification email has been sent to the address." => "Il y a déjà une inscription en attente avec cette adresse de courriel, un nouveau courriel de vérification à ete envoye.",
"A user has already taken this email, maybe you already have an account?" => "Un utilisateur a dejà pris ce courriel, peut-être avez-vous déjà un compte ?",
...
"None" => "Aucun",
"Allowed domains for registration" => "Domaines autorisés pour l'enregistrement",
"Enter a semicolon-seperated list of allowed domains. Example: owncloud.com;github.com" => "Entrez une liste de domaines autorisés, séparés d'un point-virgule. Exemple: owncloud.com;github.com",
"Registration is only allowed for following domains:" => "Enregistrement sur les domaines suivants autorisé:",
