OC.L10N.register(
    ...
    "Enter a semicolon-separated list of allowed email domains, * for wildcard. Example: %s" : "Indtast en semikolonsepareret liste over tilladte e-mail-domæner * for jokertegn. Eksempel: %s",
    "Block listed email domains instead of allowing them" : "Bloker listede email domæner istedet for at tillade dem",
    "Show the allowed/blocked email domains to users" : "Vis de tilladte/blokerede email domæner til brugerne",
    "Force email as login name" : "Gennemtving email som logonnavn",
    "Admin approval" : "Administratorgodkendelse",
