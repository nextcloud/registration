OC.L10N.register(
    ...
    "Add additional user instructions (e.g. for choosing their login name). If configured the text is displayed in the account creation step of the registration process." : "Bir ek kullanıcı yönergesi ekleyin (kullanıcı adının seçilmesi gibi). Yapılandırılmış ise, bu metin hesap açma işleminin hesap oluşturma adımında görüntülenir.",
    ...
    "Add additional user instructions (e.g. for choosing their login name). If configured the text is embedded in the verification-email." : "Bir ek kullanıcı yönergesi ekleyin (kullanıcı adının seçilmesi gibi). Yapılandırılmış ise, bu metin doğrulama e-postasına eklenir.",
