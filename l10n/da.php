...
"To create a new account on ownCloud, just click the following link:<br/>{link}" => "For at oprette en ny konto på ownCloud, klik følgende link:<br />{link}",
...
"You will receive an email with verification link" => "Du vil modtage en e-mail med et verifikationslink"
);
