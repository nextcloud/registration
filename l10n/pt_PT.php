...
"Thank you for registering, you should receive verification link in a few minutes." => "Obrigado por registar, em alguns minutos você receberá um email de confirmação com um link.",
"Email" => "Email",
"Request verification link" => "solicitar um link de confirmação",
"Please re-enter a valid email address" => "Por favor digitar novamente um endereço de correio válido",
"You will receive an email with verification link" => "Você receberá uma mensagem de correio electrónico com um link para verificação da sua conta"
);
