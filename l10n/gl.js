OC.L10N.register(
    ...
    "Email address verified, you can now complete your registration." : "Enderezo de correo verificado, agora pode completar o seu rexistro.",
    ...
    "no email address given" : "non se proporcionou ningún enderezo de correo electrónico",
    "\"%1$s\" (%2$s) registered a new account on %3$s." : "\"%1$s\" (%2$s) rexistrou unha nova conta en %3$s.",
    "\"%1$s\" (%2$s) registered a new account on %3$s and needs to be enabled." : "\"%1$s\" (%2$s) rexistrou unha nova conta en %3$s e é necesario activala.",
    ...
    "Please provide a valid login name." : "Proporcione un nome de inicio de sesión válido.",
    "The login name you have chosen already exists." : "O nome de inicio de sesión que escolliches xa existe.",
    ...
    "This app allows users to self-register a new account using their email address." : "Esta aplicación permite aos usuarios rexistrar unha nova conta usando o seu enderezo de correo electrónico.",
    "User registration\n\nThis app allows users to register a new account.\n\n# Features\n\n- Add users to a given group\n- Allow-list with email domains (including wildcard) to register with\n- Administrator will be notified via email for new user creation or require approval\n- Supports Nextcloud's Client Login Flow v1 and v2 - allowing registration in the mobile Apps and Desktop clients\n\n# Web form registration flow\n\n1. User enters their email address\n2. Verification link is sent to the email address\n3. User clicks on the verification link\n4. User is lead to a form where they can choose their username and password\n5. New account is created and is logged in automatically" : "Rexistro de usuario\n\nEsta aplicación permite aos usuarios rexistrar unha nova conta.\n\n# Características\n\n- Engadir usuarios a un grupo determinado\n- Lista de permisos con dominios de correo electrónico (incluído wildcard) para rexistrarse\n- O administrador será notificado por correo electrónico para a creación de novos usuarios ou requirir aprobación\n- Admite o fluxo de inicio de sesión de cliente de Nextcloud v1 e v2, permitindo o rexistro nas aplicacións móbiles e nos clientes de escritorio\n\n# Fluxo de rexistro de formularios web\n\n1. O usuario introduce o seu enderezo de correo electrónico\n2. Envíase a ligazón de verificación ao enderezo de correo electrónico\n3. O usuario fai clic na ligazón de verificación\n4. O usuario é dirixido a un formulario onde pode escoller o seu nome de usuario e contrasinal\n5. Créase unha nova conta e inicia sesión automaticamente",
    "Registration settings" : "Configuración de rexistro",
    "Require administrator approval" : "Require aprobación do administrador",
    "Enabling \"administrator approval\" will prevent registrations from mobile and desktop clients to complete as the credentials cannot be verified by the client until the user was enabled." : "Habilitando a \"aprobación do administrador\" impedirá que se completen os rexistros desde clientes móbiles e de escritorio, xa que o cliente non pode verificar as credenciais ata que o usuario estea habilitado.",
    ...
    "Email is optional" : "O correo electrónico é opcional",
    "Block listed email domains instead of allowing them" : "Bloquear os dominios de correo-e listados no canto de permitilos",
    "Disable email verification" : "Desactivar a verificación do correo electrónico",
    "User settings" : "Axustes de usuario",
    "Force email as login name" : "Forzar o correo-e como nome de inicio de sesión",
    "Login name policy" : "Política de nome de inicio de sesión",
    "Regular expression to validate login names" : "Expresión regular para validar nomes de inicio de sesión",
    "If configured, login names will be validated through the regular expression. If the validation fails the user is prompted with a generic error. Make sure your regex is working correctly." : "Se está configurado, os nomes de inicio de sesión validaranse mediante a expresión regular. Se a validación falla, o usuario recibe un erro xenérico. Asegúrate de que a túa expresión regular funciona correctamente.",
    "Show full name field" : "Mostrar campo de nome completo",
    "Enforce full name field" : "Campo de nome completo obligatorio",
    "Show phone field" : "Mostrar campo de teléfono",
    "Enforce phone field" : "Campo de teléfono obligatorio",
    ...
    "A short message that is shown to the user in the registration process." : "Unha mensaxe curta que se mostra ao usuario no proceso de rexistro.",
    ...
    "Verification email instructions" : "Instrucións de verificación por correo electrónico",
    "A short message that is shown to the user in the verification email." : "Unha mensaxe curta que se mostra ao usuario no correo electrónico de verificación.",
    "Add additional user instructions (e.g. for choosing their login name). If configured the text is embedded in the verification-email." : "Engade instrucións de usuario adicionais (por exemplo, para escoller o seu nome de inicio de sesión). Se está configurado, o texto está incrustado no correo electrónico de verificación.",
    "Blocked email domains" : "Dominios de correo electrónico bloqueados",
    "Allowed email domains" : "Dominios de correo-e permitidos",
    "Show the blocked email domains to users" : "Mostra os dominios de correo electrónico bloqueados aos usuarios",
    "Show the allowed email domains to users" : "Mostra os dominios de correo electrónico permitidos aos usuarios",
    "An error occurred while saving the settings" : "Produciuse un erro ao gardar a configuración",
