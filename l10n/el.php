...
"There is already a pending registration with this email" => "Εκκρεμεί ήδη μία εγγραφή με αυτό το email",
"Verify your ownCloud registration request" => "Επιβεβαιώστε την αίτηση εγγραφής στο ownCloud",
"Invalid verification URL. No registration request with this verification URL is found." => "Μη έγκυρο URL επιβεβαίωσης. Καμία αίτηση εγγραφής δε βρέθηκε με αυτό το URL επιβεβαίωσης.",
