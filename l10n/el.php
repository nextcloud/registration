...
"To create a new account on ownCloud, just click the following link: {link}" => "Για να δημιουργήσετε ένα νέο λογριασμό στο ownCloud, κάντε κλικ στον ακόλουθο σύνδεσμο: {link}",
