OC.L10N.register(
    ...
    "Email address verified, you can now complete your registration." : "Die E-Mail-Adresse wurde verifiziert, Sie können nun Ihre Registrierung abschließen.",
    ...
    "Require administrator approval" : "Genehmigung durch Administration erforderlich",
    "Enabling \"administrator approval\" will prevent registrations from mobile and desktop clients to complete as the credentials cannot be verified by the client until the user was enabled." : "Die Aktivierung von \"Genehmigung durch Administration\" verhindert, dass Registrierungen von mobilen und Desktop-Clients abgeschlossen werden können, da die Anmeldedaten vom Client nicht überprüft werden können, bevor das Konto aktiviert wurde.",
    ...
    "Enforce phone field" : "Erzwinge Feld für die Telefonnummer an",
    ...
    "Your account has been successfully created, but it still needs approval from an administrator." : "Ihr Konto wurde erstellt, muss aber noch von der Administration genehmigt werden."
},
