OC.L10N.register(
    ...
    "\"%1$s\" (%2$s) registered a new account on %3$s." : "\"%1$s\" (%2$s) hat ein neues Konto auf %3$s registriert.",
    "\"%1$s\" (%2$s) registered a new account on %3$s and needs to be enabled." : "\"%1$s\" (%2$s) hat ein neues Konto auf %3$s registriert und muss freigeschaltet werden.",
