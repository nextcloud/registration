...
"Verification email successfully sent." => "Имейл за проверка успешно изпратен.",
...
"To create a new account on ownCloud, just click the following link:<br/>{link}" => "За да създадеш нов профил в ownCloud, следвай следната връзка:<br/>{link}",
