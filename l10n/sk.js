OC.L10N.register(
    "registration",
    {
    "Registration is not allowed with the following domains: %s" : "Registrácia nie je povolená s nasledujúcimi doménami: %s",
    "Registration is only allowed with the following domains: %s" : "Registrácia je povolená iba s nasledujúcimi doménami: %s",
    ...
    "New user \"%1$s\" has created an account on %2$s" : "Nový používateľ „%1$s“ si vytvoril účet na %2$s",
    ...
    "Require administrator approval" : "Vyžaduje schválenie správcom",
    ...
    "Please create your username following the scheme " : "Vytvorte si svoje používateľské meno podľa schémy",
