OC.L10N.register(
    ...
    "Let user can register directly without email verification" : "Umožniť používateľovi zaregistrovať sa priamo bez overenia e-mailom",
    "Allowed email domains" : "Povolené e-mailové domény",
    "Username policy" : "Pravidlá pre meno používateľa",
    "If configured, usernames will be validated through the regular expression. If the validation fails the user is prompted with a generic error. Make sure your regex is working correctly." : "Ak je nakonfigurované, používateľské mená sa budú overovať pomocou regulárneho výrazu. Ak overenie zlyhá, zobrazí sa používateľovi všeobecná chyba. Uistite sa, že váš regulárny výraz správne funguje.",
