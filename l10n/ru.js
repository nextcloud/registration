OC.L10N.register(
    ...
    "Email address verified, you can now complete your registration." : "Ваш адрес Email проверен, теперь вы можете завершить регистрацию.",
    ...
    "New user \"%s\" has created an account on %s" : "Новый пользователь \"%s\" создал аккаунт на \"%s\"",
    "New user registered" : "Новый пользователь зарегистрировался",
    "\"%1$s\" registered a new account on %2$s." : "\"%1$s\" зарегистрировал новый аккаунт на \"%2$s\".",
    "\"%1$s\" registered a new account on %2$s and needs to be enabled." : "\"%1$s\" зарегистрировал новый аккаунт на \"%2$s\" и должен быть активирован.",
    ...
    "Registration app auto setup" : "автонастройка приложения \"Регистрация\"",
