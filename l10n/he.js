OC.L10N.register(
    ...
    "Verification email instructions" : "הנחיות לדוא״ל אימות",
    "A short message that is shown to the user in the verification email." : "הודעה קצרה שמופיעה למשתמש בהודעת האימות בדוא״ל.",
    "Add additional user instructions (e.g. for choosing their login name). If configured the text is embedded in the verification-email." : "ניתן לציין הנחיות נוספות (למשל: לבחור את שם המשתמש). אם הטקסט הוגדר הוא יוטמע בהודעת האימות.",
    "Blocked email domains" : "שמות תחום חסומים לדוא״ל",
    "Allowed email domains" : "דומייני אימייל מותרים",
    "Show the blocked email domains to users" : "להציג את שמות התחום החסומים לדוא״ל למשתמשים",
    "Show the allowed email domains to users" : "להציג את שמות התחום המורשים לדוא״ל למשתמשים",
    "An error occurred while saving the settings" : "אירעה שגיאה בשמירת ההגדרות",
    "Loading …" : "בטעינה…",
    ...
    "Email" : "דוא״ל",
    "Continue" : "להמשך",
    "Request verification code" : "לדרוש קוד אימות",
