OC.L10N.register(
    ...
    "Unable to create user, there are problems with the user backend." : "Неможливо створити користувача, виникли проблеми з серверною частиною системи.",
    "Unable to set user email: " : "Неможливо налаштувати електронну адресу користувача:",
    "Registration app auto setup" : "Автоматичне налаштування застосунку для реєстрації",
    "This app allows users to self-register a new account using their email address." : "Цей застосунок дозволяє користувачеві реєструвати самостійно новий обліковий запис із використанням його електронної адреси.",
    "User registration\n\nThis app allows users to register a new account.\n\n# Features\n\n- Add users to a given group\n- Allow-list with email domains (including wildcard) to register with\n- Administrator will be notified via email for new user creation or require approval\n- Supports Nextcloud's Client Login Flow v1 and v2 - allowing registration in the mobile Apps and Desktop clients\n\n# Web form registration flow\n\n1. User enters their email address\n2. Verification link is sent to the email address\n3. User clicks on the verification link\n4. User is lead to a form where they can choose their username and password\n5. New account is created and is logged in automatically" : "Реєстрація користувача\n\nЦя програма дозволяє користувачам реєструвати новий обліковий запис.\n\n# Функції\n\n- Додавання користувачів до певної групи\n- Список дозволених доменів електронної пошти (включаючи символи-замінники) для реєстрації\n- Адміністратор отримує повідомлення електронною поштою про створення нового користувача або про необхідність затвердження\n- Підтримка Nextcloud's Client Login Flow v1 та v2 - дозволяє реєструватися в мобільних застосунках та настільних клієнтах\n\n# Процес реєстрації через веб-форму\n\n1. Користувач вводить свою адресу електронної пошти\n2. На адресу електронної пошти надсилається посилання для підтвердження\n3. Користувач натискає на посилання для підтвердження\n4. Користувач переходить до форми, де може вибрати ім'я користувача та пароль\n5. Створюється новий обліковий запис, і користувач автоматично входить у систему",
    ...
    "Enabling \"administrator approval\" will prevent registrations from mobile and desktop clients to complete as the credentials cannot be verified by the client until the user was enabled." : "Увімкнення функції «затвердження адміністратором» запобігатиме завершенню реєстрації з мобільних та настільних клієнтів, оскільки клієнт не може перевірити облікові дані, доки користувач не буде активований.",
    ...
    "If configured, login names will be validated through the regular expression. If the validation fails the user is prompted with a generic error. Make sure your regex is working correctly." : "Якщо налаштовано, імена для входу будуть перевірятися за допомогою регулярного виразу. Якщо перевірка не пройде, користувачеві буде показано загальне повідомлення про помилку. Переконайтеся, що ваш регулярний вираз працює правильно.",
    "Show full name field" : "Показати поле для імені повністю",
    "Enforce full name field" : "Змусити заповнювати поле повного імені",
    "Show phone field" : "Показати поле для номера телефону",
    "Enforce phone field" : "Змусити заповнити поле номера телефону",
