OC.L10N.register(
    ...
    "\"%1$s\" registered a new account on %2$s." : "\"%1$s\" új fiókot regisztrált a(z) %2$s oldalon.",
    "\"%1$s\" registered a new account on %2$s and needs to be enabled." : "\"%1$s\" új fiókot regisztrált a(z) %2$s webhelyen amelyet engedélyezni kell.",
    ...
    "Your account has been successfully created, you can <a href=\"%s\">log in now</a>." : "Fiók sikeresen létrejött, <a href=\"%s\"> most bejelentkezhet </a>.",
    ...
    "Invalid verification URL. No registration request with this verification URL is found." : "Événytelen ellenőrzési URL. Nem található regisztrációs kérelem ezzel az ellenőrzési URL-lel.",
    ...
    "User registration\n\nThis app allows users to register a new account.\n\n# Flow\n\n1. User enters his/her email\n2. Verification link is sent to the email address\n3. User clicks on the verification link\n4. User is lead to a form where one can choose username and password\n5. New account is created and is logged in automatically\n\n# Features\n\n- Admin can specify which group the newly created users belong\n- Admin can limit the email domains allowed to register\n- Admin will be notified by email for new user creation\n\n# Donate\n\nSend Ethereum to `0x941613eBB948C2C547cb957B55fEB2609fa6Fe66`\nSend BTC to `33pStaSaf4sDUA8XBAHTq7ZDQpCVFQArxQ`" : "Felhasználó regisztráció\n\nEz az alkalmazás lehetővé teszi a felhasználók számára, hogy új fiókot regisztráljanak.\n\n# Folyamat:\n\n1. A felhasználó megadja az e-mailjét\n2. Az ellenőrző linket elküldjük az e-mail címre\n3. A felhasználó az ellenőrző linkre kattint\n4. A felhasználó egy olyan űrlapra jut, ahol kiválaszthatja a felhasználónevet és a jelszót\n5. Új fiók jön létre, és automatikusan bejelentkezik\n\n# Jellemzők\n- Az adminisztrátor megadhatja, hogy az újonnan létrehozott felhasználók melyik csoporthoz tartoznak\n- Az adminisztrátor korlátozhatja a regisztrációhoz engedélyezett e-mail domaineket\n- Az adminisztrátort e-mailben értesítjük az új felhasználók létrehozásáról\n\n# Adomány\nKüldje az Ethereumot a \"0x941613eBB948C2C547cb957B55fEB2609fa6Fe66\" címre\nKüldje a BTC-t a `33pStaSaf4sDUA8XBAHTq7ZDQpCVFQArxQ` címre",
    "Default group that all registered users belong" : "Alapértelmezett csoport, amelyhez az összes regisztrált felhasználó tartozik",
    "None" : "Nincs",
    "Allowed mail address domains for registration" : "Engedélyezett regisztrációs email név domainek",
    "Enter a semicolon-separated list of allowed domains. Example: owncloud.com;github.com" : "Adjon meg egy pontosvesszővel elválasztott listát az engedélyezett tartományokról. Példa: owncloud.com; github.com",
    "Require admin approval?" : "Szükséges rendszergazdai engedély?",
    "Registration is only allowed for the following domains:" : "A regisztráció csak a következő domainek számára engedélyezett:",
    "A new user \"%s\" has created an account on %s and awaits admin approbation" : "Egy új felhasználó (\"%s\") létrehozott egy fiókot a(z) %s webhelyen, és várja az adminisztrátor jóváhagyását",
    "To create a new account on %s, just click the following link:" : "Új fiók létrehozásához a(z) %s webhelyen kattintson a következő linkre:",
