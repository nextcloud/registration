OC.L10N.register(
    ...
    "\"%1$s\" (%2$s) registered a new account on %3$s." : "\"%1$s\" (%2$s) új fiókot regisztrált a(z) %3$s oldalon.",
    "\"%1$s\" (%2$s) registered a new account on %3$s and needs to be enabled." : "\"%1$s\" (%2$s) új fiókot regisztrált a(z) %3$s oldalon, amelyet engedélyez kell.",
    ...
    "Email is optional" : "Az email opcionális",
    ...
    "Email (optional)" : "Email (opcionális)",
    "Email" : "E-mail",
    "Continue" : "Folytatás",
