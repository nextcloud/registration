OC.L10N.register(
    ...
    "Enter a semicolon-separated list of allowed email domains, * for wildcard. Example: %s" : "Kirjoita puolipisteellä erotettu lista sallitujen sähköpostiosoitteiden verkkotunnuksista. Esimerkki: %s",
    "Show the allowed/blocked email domains to users" : "Näytä sallittujen/estettyjen sähköpostiosoitteiden verkkotunnukset käyttäjille",
    "Force email as login name" : "Pakota sähköpostiosoite kirjautumisnimeksi",
    "Admin approval" : "Ylläpitäjän hyväksyntä",
