OC.L10N.register(
    ...
    "New user \"%1$s\" has created an account on %2$s" : "新使用者「%1$s」已於 %2$s 建立帳號",
    "New user registered" : "新使用者已註冊",
    "no email address given" : "未提供電子郵件地址",
    ...
    "Enabling \"administrator approval\" will prevent registrations from mobile and desktop clients to complete as the credentials cannot be verified by the client until the user was enabled." : "啟用「管理員批准」將會讓行動裝置與桌面客戶端無法完成註冊，因為在啟用使用者前，客戶端無法驗證憑證。",
    "Registered users default group" : "註冊使用者的預設群組",
    "Select group" : "選取群組",
    "Email settings" : "電子郵件設定",
    "Email is optional" : "電子郵件為選填",
