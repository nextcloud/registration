OC.L10N.register(
    ...
    "If configured usernames will be validated through the regular expression. If the validation fails the user is prompted with a generic error. Make sure your regex is working correctly." : "Se i nomi utente configurati saranno convalidati tramite l'espressione regolare. Se la convalida non riesce, all'utente viene presentato un errore generico. Assicurati che la tua espressione regolare funzioni correttamente.",
