OC.L10N.register(
    ...
    "\"%1$s\" registered a new account on %2$s." : "\"%1$s\" at registradu unu contu nou in %2$s.",
    "\"%1$s\" registered a new account on %2$s and needs to be enabled." : "\"%1$s\" at registradu unu contu nou in %2$s e depet èssere ativadu.",
    ...
    "User registration\n\nThis app allows users to register a new account.\n\n# Features\n\n- Add users to a given group\n- Allow-list with email domains (including wildcard) to register with\n- Admins will be notified via email for new user creation or require approval\n- Supports Nextcloud's Client Login Flow v1 and v2 - allowing registration in the mobile Apps and Desktop clients\n\n# Web form registration flow\n\n1. User enters their email address\n2. Verification link is sent to the email address\n3. User clicks on the verification link\n4. User is lead to a form where they can choose their username and password\n5. New account is created and is logged in automatically" : "Registrazione utente\n\nCusta aplicatzione permitit a is utentes de registrae unu contu nou.\n\n# Funzionalidades\n\n- Agiùnghere utentes a unu grupu pretzisu\n- Elencu de domìnios de posta permìtidos (incluidos is caràteres jolly) pro si registrare\n- Is amministradores ant a retzire una notìfica tràmite posta eletrònica pro sa creatzione de un'utente nou o ant a rechèdere s'aprovu\n- Suportat su Client Login Flow de Nextcloud v1 e v2 - cunsentende sa registratzione in is aplicatziones mòbiles e in is clientes de iscrivania\n\n# Flussu de registratzione de su mòdulu web\n\n1. S'utente insertat s'indiritzu suo de posta eletrònica\n2. Su ligòngiu de verìfica benit imbiadu a s'indiritzu de posta\n3. S'utente incarcat in su ligòngiu de verìfica\n4. S'utente benit deretadu a unu mòdulu in ue si podet seberare su nùmene utente e sa crae\n5. Su contu nou nch'est creadu e s'intrat in manera automàtica",
    "Registration settings" : "Impostatziones de registratzione",
    "Require admin approval" : "Rechedet s'asprovu de s'amministradore",
    "Enabling \"admin approval\" will prevent registrations from mobile and desktop clients to complete as the credentials cannot be verified by the client until the user was enabled." : "S'ativatzione de \"aprovatzione de s'amministradore\" at a impedire de cumpletare sa registratzione dae dispositivos mòbiles e elaboradores dae chi is credentziales non si podent verificare fintzas a cando s'utente est ativadu.",
