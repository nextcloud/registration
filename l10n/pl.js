OC.L10N.register(
    "registration",
    {
    "Registration is not allowed with the following domains: %s" : "Rejestracja nie jest dozwolona z następujących domen: %s",
    "Registration is only allowed with the following domains: %s" : "Rejestracja jest dozwolona tylko z następującymi domenami: %s",
    ...
    "Require administrator approval" : "Wymagaj zatwierdzenia przez administratora",
    ...
    "Please create your username following the scheme " : "Utwórz swoją nazwę użytkownika zgodnie ze schematem",
