OC.L10N.register(
    ...
    "Let user can register directly without email verification" : "Pozwól użytkownikowi zarejestrować się bezpośrednio bez weryfikacji adresu e-mail",
    ...
    "Username policy" : "Zasady nazwy użytkownika",
    "If configured, usernames will be validated through the regular expression. If the validation fails the user is prompted with a generic error. Make sure your regex is working correctly." : "Jeśli skonfigurowano, nazwy użytkowników zostaną sprawdzane za pomocą wyrażenia regularnego. Jeśli walidacja nie powiedzie się, użytkownik zostanie poproszony o ogólny błąd. Upewnij się, że Twoje wyrażenie regularne działa poprawnie.",
    ...
    "Add additional user instructions (e.g. for choosing their usernames). If configured the text is displayed in the account creation step of the registration process." : "Dodaj dodatkowe instrukcje dla użytkownika (np. dotyczące wyboru nazwy użytkownika). Jeśli skonfigurowany tekst jest wyświetlany na etapie tworzenia konta w procesie rejestracji.",
    "Add additional user instructions (e.g. for choosing their usernames). If configured the text is embedded in the the verification-Email." : "Dodaj dodatkowe instrukcje dla użytkownika (np. dotyczące wyboru nazwy użytkownika). Jeśli skonfigurowany tekst jest osadzany w e-mailu weryfikacyjnym.",
