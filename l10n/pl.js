OC.L10N.register(
    ...
    "\"%1$s\" registered a new account on %2$s." : "\"%1$s\" zarejestrował nowe konto w %2$s.",
    "\"%1$s\" registered a new account on %2$s and needs to be enabled." : "\"%1$s\" zarejestrował nowe konto w %2$s i musi zostać włączone.",
    ...
    "Require admin approval?" : "Wymagać zatwierdzenia przez administratora?",
    "Registration is only allowed for the following domains:" : "Rejestracja jest dozwolona tylko dla następujących domen:",
