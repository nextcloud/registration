OC.L10N.register(
    ...
    "Your account has been successfully created, but it still needs approval from an administrator." : "สร้างบัญชีของคุณเรียบร้อยแล้ว แต่ยังต้องรอการอนุมัติจากผู้ดูแลระบบ",
    "Saved" : "บันทึกแล้ว",
    ...
    "Require admin approval?" : "ต้องได้รับการอนุมัติจากผู้ดูแล?",
    "Registration is only allowed for the following domains:" : "ลงทะเบียนจะได้รับอนุญาตสำหรับโดเมนต่อไปนี้เท่านั้น:",
    "A new user \"%s\" has created an account on %s and awaits admin approbation" : "ผู้ใช้ใหม่ชื่อ \"%s\" ได้สร้างบัญชีบน %s แล้วและกำลังรอการอนุมัติจากผู้ดูแลระบบ",
