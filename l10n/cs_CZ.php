...
"Verification email successfully sent." => "Ověřovací e-mail úspěšně odeslán.",
...
"To create a new account on ownCloud, just click the following link:<br/>{link}" => "Pro vytvoření nového účtu v ownCloud klikněte na následující odkaz:<br>{link}",
...
"Please re-enter a valid email address" => "Zadejte znovu platnou e-mailovou adresu",
"You will receive an email with verification link" => "Obdržíte e-mail s ověřovacím odkazem"
);
