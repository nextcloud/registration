OC.L10N.register(
    ...
    "Let user can register directly without email verification" : "讓用戶可以直接註冊而不需要電子郵件驗證",
    ...
    "Show the allowed/blocked email domains to users" : "向用戶顯示允許／封鎖的電子郵件網域",
    ...
    "Add additional user instructions (e.g. for choosing their usernames). If configured the text is displayed in the account creation step of the registration process." : "新增其他用戶操作指南（例如選擇他們的用戶名稱）。若設定，這些文字將會在註冊過程中的賬號建立步驟顯示。",
    "Add additional user instructions (e.g. for choosing their usernames). If configured the text is embedded in the the verification-Email." : "新增其他用戶操作指南（例如選擇他們的用戶名稱）。若設定，這些文字將會嵌入至驗證電子郵件中。",
